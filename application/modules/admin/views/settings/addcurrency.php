	        ...
	        <div class="col-md-7 col-md-offset-2-5">
	            ...
	            <div class="block">
	                ...
	                <div class="block-title">
	                    ...
	                    <h2><strong>Add Currency</strong></h2>
	                </div>
	                <!-- END Form Elements Title -->

	                <!-- Basic Form Elements Content -->
	                <form id = "userAddForm" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" action="<?php echo BASE_URL.'admin/settings/insertCurrency'; ?>"> 
                    <div class="form-group">
	                        <label for="name" class="col-md-4 control-label">Currency name<span class="text-danger">*</span></label>
	                        <div class="col-md-7">
	                            <input type="text" placeholder="Currency name" class="form-control" name="name" id="name" value="<?php echo set_value('name'); ?>">
						...
						<div class="form-group">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" placeholder="Currency symbol" class="form-control" name="symbol" id="symbol" value="<?php echo set_value('symbol'); ?>">
	                    ...
	                    <div class="form-group form-actions">
	                        <div class="col-md-9 col-md-offset-4">
	                            <button class="btn btn-sm btn-primary" type="submit"><i class="fa fa-angle-right"></i> Add Currency</button>
	                        </div>
	                    </div>
	                </form>
