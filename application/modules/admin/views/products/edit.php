    ...
    <div class="row">
        <div class="col-md-7 col-md-offset-2-5">
            ...
            <div class="block">
                ...
                <form id="form-validation" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" action="<?php echo BASE_URL . 'admin/products/update'; ?>">
                    <input type="hidden" name="id" id="id" value="<?php echo $products[0]->id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            ...
                            if (isset($products[0]->category_id)) {
                                $select = $products[0]->category_id;
                            } else
                                $select = "";
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" placeholder="Product name" class="form-control" name="name" id="name" value="<?php if (isset($products[0]->name)) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" placeholder="Unit" class="form-control" name="unit" id="unit" value="<?php if (isset($products[0]->unit)) {
                                                                                                                        echo $products[0]->unit;
                                                                                                                    }
                                                                                                                    echo set_value('unit'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" placeholder="AH" class="form-control" name="ah" id="ah" value="<?php if (isset($products[0]->ah)) {
                                                                                                                    echo $products[0]->ah;
                                                                                                                }
                                                                                                                echo set_value('ah'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" placeholder="MRP" class="form-control" name="mrp" id="mrp" value="<?php if (isset($products[0]->mrp)) {
                                                                                                                        echo $products[0]->mrp;
                                                                                                                    }
                                                                                                                    echo set_value('mrp'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" placeholder="Default Dealer Price" class="form-control" name="default_dealer_price" id="default_dealer_price" value="<?php if (isset($products[0]->default_dealer_price)) {
                                                                                                                                                                        echo $products[0]->default_dealer_price;
                                                                                                                                                                    }
                                                                                                                                                                    echo set_value('default_dealer_price'); ?>">
                            <?php if (form_error('default_dealer_price')) { ?>
                                <div id="default_dealer_price-2-error" class="help-block animation-slideDown falseForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="number" placeholder="Sort" class="form-control" name="sort_order" id="sort_order" value="<?php if (isset($products[0]->sort_order)) {
                                                                                                                                        echo $products[0]->sort_order;
                                                                                                                                    }
                                                                                                                                    echo set_value('sort_orde'); ?>" min="0">
