<?php include ASSPATH.'inc/config.php'; ?>
<?php include ASSPATH.'inc/template_start.php'; ?>

<!-- Login Background -->
<div id="login-background">
    <!-- For best results use an image with a resolution of 2560x400 pixels (prefer a blurred image for smaller file size) -->
    <img src="<?php echo ASSETS_IMAGE; ?>placeholders/headers/login_header.jpg" alt="Login Background" class="animation-pulseSlow">
</div>
 ...
 <div id="login-container" class="animation-fadeIn">
    ...
    <div class="login-title text-center">
        <h1><!-- <i class="gi gi-flash"></i> --> 
            <img src="../assets/hir.png" style="width: 100%; align-items: center; height: 241px;"><strong><?php echo $template['name']; ?></strong><br><small>Please <strong>Login</strong> or <strong>Register</strong></small></h1>
    </div>
    <!-- END Login Title -->
    ...
    <div class="block push-bit">
        <!-- Login Form -->
        <form action="<?php echo base_url().'admin/login'; ?>" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
            <div class="form-group has-error">
                <div class="col-xs-12">
                    <div id="login-common-error" class="help-block animation-slideDown"><?php echo validation_errors(); ?></div>
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
                        ...
                        <input type="text" id="login-username" name="login-username" class="form-control input-lg" placeholder="Email address">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group form-actions">
                ...
                <div class="col-xs-8 text-right pull-right">
                    <button type="submit" class="btn btn-sm btn-primary iconbg"><i class="fa fa-angle-right"></i> Login to Dashboard</button>
                </div>
            </div>
    ...
    <footer class="text-muted text-center">
        <small><span id="year-copy"></span>&nbsp;&nbsp;&copy;&nbsp;&nbsp;HIR Industries. All Rights Reserved.</a></small>
    </footer>
    <!-- END Footer -->
</div>
</div>
...
<script src="<?php echo ASSETS_JS; ?>pages/login.js"></script>
