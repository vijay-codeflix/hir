	        ...
	        <div class="col-md-7 col-md-offset-2-5">
	            ...
	            <div class="block">
	                ...
	                <div class="block-title">
	                    ...
	                    <h2><strong>Add Zone</strong></h2>
	                </div>
	                <!-- END Form Elements Title -->

	                <!-- Basic Form Elements Content -->
	                <form id = "form-validation" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" action="<?php echo BASE_URL.'admin/zones/insert'; ?>">
	                        	...
	                        	<select size="1" name="country_id" class="form-control">
	                        		...
	                        		if($countrylist){
	                        			for($i = 0; $i < count($countrylist); $i++){
	                        				$select = 0;//($countrylist[$i]->country_id == set_value('country_id') ? 'Selected' : '');
                        ...
                        <div class="form-group">
	                        <label for="zone_name" class="col-md-4 control-label">Zone<span class="text-danger">*</span></label>
	                        <div class="col-md-7">
	                            <input type="text" placeholder="Zone name" class="form-control" name="zone_name" id="zone_name" value="<?php if(set_value('zone_name')){ echo set_value('zone_name'); } ?>">
						...
						<div class="form-group form-actions">
	                        <div class="col-md-9 col-md-offset-4">
	                            <button class="btn btn-sm btn-primary" type="submit"><i class="fa fa-angle-right"></i> Add Zone</button>
	                        </div>
	                    </div>
	                </form>
