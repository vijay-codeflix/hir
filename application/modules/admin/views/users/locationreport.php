...
<div id="page-content">
    ...
    <div class="block full">
        ...
        <div class="row">
          <div class="col-md-12"> 
            <form id="userSearchForm" class="form-horizontal form-bordered" method="post" action="<?php echo BASE_URL.'admin/users/locationReport'; ?>">
              <div class="block col-md-4 pull-left no-border">
                <div class="form-group">
                  <label class="col-md-4 control-label" for="parent_id">Type Of User</label>
                  <div class="col-md-8">
                    <div class='input-group'>
                      <!--<input list="user_types" class="form-control" placeholder="Select user here..." name="user_type" id="search-user">-->
              ...
              <div class="block col-md-4 pull-center no-border">
                <div class="form-group">
                  <label class="col-md-4 control-label" for="parent_id">Type Of Parent User</label>
                  <div class="col-md-8">
                    <div class='input-group'>
                      <!--<input list="parent_ids" class="form-control" placeholder="Select parent user here..." name="parent_id" id="parent_id">-->
                  ...
                  <div class="col-md-12">
                    <div class="block-section text-right">
                      <button class="btn btn-sm btn-primary" type="submit"><i class="fa fa-angle-right"></i> Search</button>
                       <button class="btn btn-sm btn-primary" id="reset-btn" type="reset"><i class="fa fa-angle-right"></i> Reset</button>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="<?php echo CURRENT_MODULE.'users/locationsEmployeeDetails/'.$userId; ?>" data-toggle="tooltip" title="View details" class="btn btn-xs"><i class="fa fa-eye"></i></a>         
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
