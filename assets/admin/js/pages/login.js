...
var Login = function() {
    ...
    return {
        init: function() {
            ...
            $('#form-login').validate({
                ...
                messages: {
                    'login-username': {
                        ...
                        minlength: 'Your email must be atleast 4 characters long.',
            ...
            /* This event to clear common faild login error messages */
            $('#form-login input').keypress(function(){
                if($('#login-common-error').html()){
                    $('#login-common-error').html('');
                }
            });
