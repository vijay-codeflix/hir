...
var App = function() {
    ...
    var uiInit = function() {
        ...
        if (d.getFullYear() === 2008) { yearCopy.html('2008'); } else { yearCopy.html('20' + d.getFullYear().toString().substr(2,2) + '&nbsp;'); }
        ...
        $('a', colorList).click(function(e){
            ...
            if (themeColor === 'default') {
                ...
                if (themeLink.length) {
                    ...
                    $('link[href="application/assests/css/main.css"]').before('<link id="theme-link" rel="stylesheet" href="application/assests/css/themes/' + themeColor + '">');
                    themeLink = $('#theme-link');
                }
            }
            themeColor = 'application/assests/css/themes/' + themeColor;
    ...
    var dtIntegration = function() {
        $.extend(true, $.fn.dataTable.defaults, {
            // "sDom": "<'row'<'col-sm-6 col-xs-5'l><'col-sm-6 col-xs-7'f>r>t<'row'<'col-sm-5 hidden-xs'i><'col-sm-7 col-xs-12 clearfix'pb>>",
